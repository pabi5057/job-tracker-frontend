      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold mb-1">Job<span className="text-[#6A38C2]">Tracker</span></h2>
            <p className="text-sm">&copy; 2025 BY P<sup>2</sup> Developer. All rights reserved.</p>
          </div>
